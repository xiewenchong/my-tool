...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"Fleshy","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!******************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/pages.json ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 8 */
/*!*****************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/config.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {


var system = 'kyyWXProgram';
...
/* 18 */
/*!****************************************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/domain/account/PageAuthHelper.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//获取应用实例
var app = getApp();
var restApi = __webpack_require__(/*! ../../utils/restApi.js */ 19);
var GlobalAuthMgr = __webpack_require__(/*! ./GlobalAuthMgr.js */ 21);
...
module.exports = {
  ...
  /**
                    * 
                    */
  requestAuth: function requestAuth(pageThis, level, callback) {var showStyle = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "dlg";var desc = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "";
    var toast = pageThis.$refs.Toast;
    if (!toast) {
      throw new Error('请在页面中集成Toast组件!');
    }
    var loading = pageThis.$refs.Loading;
    if (!loading) {
      throw new Error('请在页面中集成Loading组件!');
    }
    var wxAuthDialog = pageThis.$refs.WXAuthDialog;
    if (!wxAuthDialog) {
      throw new Error('请在页面中集成WXAuthDialog组件!');
    }


    var authMgr = new GlobalAuthMgr.GlobalAuthMgr({
      onLoadingBegin: function onLoadingBegin() {
        loading.show();
      },
      ...
      onAuthDeny: function onAuthDeny() {
        console.log("onAuthDeny");
      },
      onRequestPermission: function onRequestPermission(provider, extConfig) {
        if (provider == "weixin") {
          wxAuthDialog.init({
            title: extConfig.businessName,
            desc: desc != "" ? desc : extConfig.businessAuthDesc,
            iconUrl: extConfig.businessLogo,
            onGetUserInfoResult: function onGetUserInfoResult(res) {
...
/* 19 */
/*!************************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/utils/restApi.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
 ...
 */
//var app = getApp();
var util = __webpack_require__(/*! ./miscUtil */ 20);
var appConfig = __webpack_require__(/*! ../config.js */ 8);


var restApi = module.exports = {
  getForGivenApp: function getForGivenApp(appGiven, reqUrl, reqParams, fn_cb) {
  ...
  postForGivenApp: function postForGivenApp(app, reqUrl, reqParams, fn_cb) {
  ...
  _get: function _get(url, data, success, fail, complete) {
    _Request(url, data, null, "GET", null, success, fail, complete);
  },

  _post: function _post(url, data, success, fail, complete) {
    _Request(url, data, null, "POST", null, success, fail, complete);
  },

  _HGet: function _HGet(url, data, header, success, fail, complete) {
    _Request(url, data, header, "GET", null, success, fail, complete);
  },

  _HPost: function _HPost(url, data, header, success, fail, complete) {
    _Request(url, data, header, "POST", null, success, fail, complete);
  },

  rawReq: function rawReq(p) {
    uni.request(p);
  } };
...
/* 20 */
/*!*************************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/utils/miscUtil.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {module.exports = {
  isDef: function isDef(value) {
  ...
  dateToStr: function dateToStr(date, pattern) {
    if (this.isStr(date)) {
      return date;
    }
  ...
  strToDate: function strToDate(str, delimiter, pattern) {
    if (this.isDate(str)) {
      return str;
    }
  ...
  addYear: function addYear(date, n, month, day) {
  ...
  forEach: function forEach(object, fn, bind, inverse) {
  ...
  every: function every(object, fn, bind) {
  ...
  some: function some(object, fn, bind) {
    if (object && object.length) {// 数组、arguments、nodeList等有长度的数据
  ...
  converToZero: function converToZero(str) {
  ...
  notNullStr: function notNullStr(str) {
  ...
  //比较两个日期相差时间
  subTime: function subTime(date1, date2)
  {
  ...
  /**
      * 告诉上一个页面从哪里返回，务必在当前页面onUnload时使用
      * @param name
      */
  onPageResult: function onPageResult(result) {
    try {

      console.log("invoking Util.onPageResult...");
      console.log(result);
      ...
      // 务必在当前页面onUnload时使用, 这样最后一个页面就是上一个页面
      var prevPage = pages[pages.length - 1]; //上一页页面实例
      prevPage.$vm.onPageResult = result; //修改上一页data里面的searchVal参数值为1211
  ...
  /**
      ...
      * @param name
      */
  setReturnPageName: function setReturnPageName(name) {
    try {
      var pages = getCurrentPages();
      if (pages.length > 1) {
        //上一个页面实例对象
  ...
  rpx_2_px: function rpx_2_px(rpx) {
    //var rpx = 10000;
  ...
  uni_rpx_2_px: function uni_rpx_2_px(rpx) {
    //var rpx = 10000;
    var systemInfo = uni.getSystemInfoSync();
    return rpx / 750 * systemInfo.windowWidth;
  },

  rpx_2_px_w: function rpx_2_px_w(windowWidth, rpx) {
    //var rpx = 10000;
    //var systemInfo = wx.getSystemInfoSync();
    return rpx / 750 * windowWidth;
  },

  remainTimeM: function remainTimeM(time) {
    var time = parseInt(time);
  ...
  timeToDate: function timeToDate(shijianchuo) {
  ...
  parsePrice: function parsePrice(raw) {
    if (raw.indexOf('.') < 0) {
      return [raw, ''];
    }
    if (raw.indexOf('.') == 0) {
  ...
  format_with_toLocaleString: function format_with_toLocaleString(
  number,
...
/* 21 */
/*!***************************************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/domain/account/GlobalAuthMgr.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var app = getApp();
var Util = __webpack_require__(/*! ../../utils/miscUtil.js */ 20);
var userInfoRepo = __webpack_require__(/*! ../../data/account/UserInfoRepo */ 22);
...
var GlobalAuthMgr = module.exports = {
  ...
  /**
                                        ...
                                        * @param {*} callback 
                                        */
  GlobalAuthMgr: function GlobalAuthMgr(callback) {
    ...
    var done = function done(userInfo) {
    ...
    /**
        * 微信弱授权实现
        */
    var wxWeakAuthImpl_step1 = function wxWeakAuthImpl_step1() {
      console.log('GAM wxWeakAuthImpl_step1...');
      callback.onLoadingBegin();
      repo.wxGetCacheSecurityKey().then(function (securityKey) {
    ...
    var wxWeakAuthImpl_step2 = function wxWeakAuthImpl_step2() {
      console.log('GAM wxWeakAuthImpl_step2...');
      repo.wxNewSecurityKey().then(function (securityKey) {
        console.log(securityKey);
        wxWeakAuthImpl_step3(securityKey);
      }).catch(function (err) {
        handleError(err);
    ...
    var wxWeakAuthImpl_step3 = function wxWeakAuthImpl_step3(securityKey) {
      console.log('GAM wxWeakAuthImpl_step3...');
      repo.wxGetDescryptedUserInfo(securityKey).then(function (userInfo) {
    ...
    /**
        * 微信强授权实现
        */
    var wxStrongAuthImpl_step1 = function wxStrongAuthImpl_step1() {
    ...
    var wxStrongAuthImpl_step2 = function wxStrongAuthImpl_step2() {
    ...
    var wxStrongAuthImpl_step3 = function wxStrongAuthImpl_step3(securityKey) {
    ...
    var wxStrongAuthImpl_step4 = function wxStrongAuthImpl_step4(userInfo) {
    ...
    var wxStrongAuthImpl_step5 = function wxStrongAuthImpl_step5() {
      console.log('GAM wxStrongAuthImpl_step5...');
      repo.checkUserInfoAuth().then(function (suc) {
        console.log(suc);
        if (!suc) {
          callback.onLoadingEnd();
    ...
    var wxStrongAuthImpl_step6 = function wxStrongAuthImpl_step6() {
      console.log('GAM wxStrongAuthImpl_step6...');
      repo.wxGetUserInfo().then(function (authRes) {
        console.log(authRes);
        if (authRes == null) {
          callback.onLoadingEnd();
          callback.onRequestPermission('weixin', extConfig);
    ...
    var wxStrongAuthImpl_step7 = function wxStrongAuthImpl_step7(authRes) {
      console.log('GAM wxStrongAuthImpl_step7...');
      repo.wxGetDescryptedUserInfo(newSecurityKey, authRes).then(function (userInfo) {
        console.log(userInfo);
        done(userInfo);
      }).catch(function (err) {
        handleError(err);
...
/* 22 */
/*!************************************************************************!*\
  !*** E:/work/wnmp/www/ykd-miniapp/Fleshy/data/account/UserInfoRepo.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var net_fail_msg = '网络好像有点问题，请稍后再试...';
var securityKey_cache_key = 'securityKey_V37';
...
module.exports = {
  ...
  getExtConfig: function getExtConfig() {
    ...
    return extConfig || {
      ...
      businessAuthDesc: businessAuthDesc,
  ...
  /**
      ...
      * 读取缓存的securityKey
      */
  wxGetCacheSecurityKey: function wxGetCacheSecurityKey() {
  ...
  wxNewSecurityKey: function wxNewSecurityKey() {
    return new Promise(function (resolve, reject) {
      var _getSecurityKeyImpl = function _getSecurityKeyImpl(jsCode) {
        if (IS_MOCK) {
        ...
        function (res) {
          if (res.statusCode === 200 && res.data.code == 1000) {
            ...
            reject("错误504!" + res.data.message || false);
          }
        },
        function () {
          reject(net_fail_msg);
  ...
  /**
      * 调这个接口换取用户私有信息
      */
  wxGetDescryptedUserInfo: function wxGetDescryptedUserInfo(securityKey, authRes) {
    return new Promise(function (resolve, reject) {
      if (IS_MOCK) {
        // setTimeout(()=>{
        // 	if(authRes){
      ...
      if (authRes) {
        ...
        function (res) {
          if (res.statusCode === 200 && res.data.code == 1000) {
            ...
            reject("错误505!" + res.data.message || false);
          }
        },
        function () {
          reject(net_fail_msg);
        ...
        function (res) {
          if (res.statusCode === 200) {
            if (res.data.code == 1000) {
              ...
              reject("错误605!" + res.data.message || false);
            }
          } else {
            reject("错误606!" + res.data.message || false);
          }
        },
        function () {
          reject(net_fail_msg);
  ...
  /**
      * 检查用户有无授权获取私有信息
      */
  checkUserInfoAuth: function checkUserInfoAuth() {
    return new Promise(function (resolve, reject) {
      uni.getSetting({
        success: function success(res) {
  ...
  saveUserInfoSlient: function saveUserInfoSlient(authLevel, userInfo) {
    userInfo.extAppid = extAppid;
    this.writeToAppGlobal(authLevel, userInfo);
  },

  // 临时兼容,回写app.GlobalData
  writeToAppGlobal: function writeToAppGlobal(authLevel, info) {
